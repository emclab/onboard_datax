module OnboardDatax
  class OnboardEngineInit < ActiveRecord::Base
    attr_accessor :file_name, :init_code, :init_desp, :project_name, :last_updated_by_name, :engine_name, :release_name
    attr_accessible :engine_init_id, :project_id,  :engine_id, :engine_name, :project_name, :file_name, :init_code, :init_desp, :release_id,
                    :as => :role_new
    attr_accessible :project_name, :last_updated_by_name, :engine_name, :file_name, :init_code, :init_desp, :release_id,
                    :as => :role_update
    
    attr_accessor :start_date_s, :end_date_s, :file_name_s, :engine_id_s, :init_desp_s, :project_id_s, :release_id_s

    attr_accessible :start_date_s, :end_date_s, :file_name_s, :engine_id_s, :init_desp_s, :project_id_s, :release_id_s,
