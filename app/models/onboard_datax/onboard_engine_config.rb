module OnboardDatax
  class OnboardEngineConfig < ActiveRecord::Base
    ...
    attr_accessor :start_date_s, :end_date_s, :argument_name_s, :engine_name_s, :argument_desp_s, :commissioned_by_id_s, :project_id_s

    attr_accessible :start_date_s, :end_date_s, :argument_name_s, :engine_name_s, :argument_desp_s, :commissioned_by_id_s, :project_id_s,
