  ...
  describe OnboardSearchStatConfigsController do
    ...
    describe "GET 'index'" do
      it "returns all onboard engine configs" do
        ...
        q = FactoryGirl.create(:onboard_datax_onboard_search_stat_config, :search_stat_config_id => @engine_config.id, :last_updated_by_id => @u.id)
        q1 = FactoryGirl.create(:onboard_datax_onboard_search_stat_config, :project_id => q.project_id + 1, :search_stat_config_id =>  @engine_config1.id, :last_updated_by_id => @u.id )
      ...
      it "should only return the engine configs which belongs to an engine" do       
        ...
        session[:user_privilege] = Authentify::UserPrivilegeHelper::UserPrivilege.new(@u.id)
        q = FactoryGirl.create(:onboard_datax_onboard_search_stat_config, :search_stat_config_id => @engine_config.id, :last_updated_by_id => @u.id)
        q1 = FactoryGirl.create(:onboard_datax_onboard_search_stat_config, :engine_id => @sw_mod.id + 1, :search_stat_config_id =>  @engine_config1.id, :last_updated_by_id => @u.id)
      ...
      it "should return configs which belong to project" do
        ...
        session[:user_id] = @u.id
        session[:user_privilege] = Authentify::UserPrivilegeHelper::UserPrivilege.new(@u.id)
        q = FactoryGirl.create(:onboard_datax_onboard_search_stat_config,  :search_stat_config_id => @engine_config.id, :project_id => @proj.id, :last_updated_by_id => @u.id)
        q1 = FactoryGirl.create(:onboard_datax_onboard_search_stat_config, :engine_id => q.engine_id + 1, :search_stat_config_id => @engine_config1.id, :project_id => q.project_id + 1, :last_updated_by_id => @u.id)
    ...
    describe "GET 'show'" do
      it "returns http success" do
        ...
        session[:user_id] = @u.id
        session[:user_privilege] = Authentify::UserPrivilegeHelper::UserPrivilege.new(@u.id)
        q = FactoryGirl.create(:onboard_datax_onboard_search_stat_config, :last_updated_by_id => @u.id, :engine_id => @sw_mod.id, :project_id => @proj.id, :search_stat_config_id => @engine_config.id)
